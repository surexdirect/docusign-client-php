...
class BillingPlanResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Surex\\DocuSign\\Model\\BillingPlanResponse' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Surex\DocuSign\Model\BillingPlanResponse;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (property_exists($data, 'billingPlan')) {
            $object->setBillingPlan($this->denormalizer->denormalize($data->{'billingPlan'}, 'Surex\\DocuSign\\Model\\BillingPlan', 'json', $context));
        }
