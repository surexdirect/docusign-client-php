...
class UserSharedItemNormalizer extends SerializerAwareNormalizer implements DenormalizerInterface, NormalizerInterface
{
    public function supportsDenormalization($data, $type, $format = null)
    {
        if ('Surex\\DocuSign\\Model\\UserSharedItem' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Surex\DocuSign\Model\UserSharedItem) {
            return true;
        }
