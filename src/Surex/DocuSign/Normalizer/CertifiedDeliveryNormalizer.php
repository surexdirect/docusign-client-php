...
class CertifiedDeliveryNormalizer extends SerializerAwareNormalizer implements DenormalizerInterface, NormalizerInterface
{
    public function supportsDenormalization($data, $type, $format = null)
    {
        if ('Surex\\DocuSign\\Model\\CertifiedDelivery' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Surex\DocuSign\Model\CertifiedDelivery) {
            return true;
        }
    ...
    {
        $object = new \Surex\DocuSign\Model\CertifiedDelivery();
