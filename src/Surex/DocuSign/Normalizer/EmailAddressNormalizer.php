...
class EmailAddressNormalizer extends SerializerAwareNormalizer implements DenormalizerInterface, NormalizerInterface
{
    public function supportsDenormalization($data, $type, $format = null)
    {
        if ('Surex\\DocuSign\\Model\\EmailAddress' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Surex\DocuSign\Model\EmailAddress) {
            return true;
        }
    ...
    {
        $object = new \Surex\DocuSign\Model\EmailAddress();
