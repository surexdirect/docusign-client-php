...
class SignerNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Surex\\DocuSign\\Model\\Signer' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Surex\DocuSign\Model\Signer;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (property_exists($data, 'recipientSignatureProviders')) {
            ...
            foreach ($data->{'recipientSignatureProviders'} as $value_4) {
                $values_4[] = $this->denormalizer->denormalize($value_4, 'Surex\\DocuSign\\Model\\RecipientSignatureProvider', 'json', $context);
            }
        ...
        if (property_exists($data, 'signatureInfo')) {
            $object->setSignatureInfo($this->denormalizer->denormalize($data->{'signatureInfo'}, 'Surex\\DocuSign\\Model\\RecipientSignatureInformation', 'json', $context));
        }
        ...
        if (property_exists($data, 'signingGroupUsers')) {
            ...
            foreach ($data->{'signingGroupUsers'} as $value_5) {
                $values_5[] = $this->denormalizer->denormalize($value_5, 'Surex\\DocuSign\\Model\\UserInfo', 'json', $context);
            }
        ...
        if (property_exists($data, 'socialAuthentications')) {
            ...
            foreach ($data->{'socialAuthentications'} as $value_6) {
                $values_6[] = $this->denormalizer->denormalize($value_6, 'Surex\\DocuSign\\Model\\SocialAuthentication', 'json', $context);
            }
