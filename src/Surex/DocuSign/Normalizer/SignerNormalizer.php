...
class SignerNormalizer extends SerializerAwareNormalizer implements DenormalizerInterface, NormalizerInterface
{
    public function supportsDenormalization($data, $type, $format = null)
    {
        if ('Surex\\DocuSign\\Model\\Signer' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Surex\DocuSign\Model\Signer) {
            return true;
        }
    ...
    {
        $object = new \Surex\DocuSign\Model\Signer();
        ...
        if (property_exists($data, 'isBulkRecipient')) {
            $object->setIsBulkRecipient($data->{'isBulkRecipient'});
        }
        ...
        if (property_exists($data, 'recipientAttachments')) {
            ...
            foreach ($data->{'recipientAttachments'} as $value_3) {
                $values_3[] = $this->serializer->deserialize($value_3, 'Surex\\DocuSign\\Model\\RecipientAttachment', 'raw', $context);
            }
        ...
        if (property_exists($data, 'recipientSignatureProviders')) {
            $values_4 = [];
            foreach ($data->{'recipientSignatureProviders'} as $value_4) {
                $values_4[] = $this->serializer->deserialize($value_4, 'Surex\\DocuSign\\Model\\RecipientSignatureProvider', 'raw', $context);
            }
            $object->setRecipientSignatureProviders($values_4);
        }
        ...
        if (property_exists($data, 'signingGroupUsers')) {
            $values_5 = [];
            foreach ($data->{'signingGroupUsers'} as $value_5) {
                $values_5[] = $this->serializer->deserialize($value_5, 'Surex\\DocuSign\\Model\\UserInfo', 'raw', $context);
            }
            $object->setSigningGroupUsers($values_5);
        }
        ...
        if (property_exists($data, 'socialAuthentications')) {
            $values_6 = [];
            foreach ($data->{'socialAuthentications'} as $value_6) {
                $values_6[] = $this->serializer->deserialize($value_6, 'Surex\\DocuSign\\Model\\SocialAuthentication', 'raw', $context);
            }
            $object->setSocialAuthentications($values_6);
        }
    ...
    public function normalize($object, $format = null, array $context = [])
    {
        ...
        if (null !== $object->getIsBulkRecipient()) {
            $data->{'isBulkRecipient'} = $object->getIsBulkRecipient();
        }
        ...
        if (null !== $object->getRecipientSignatureProviders()) {
            $values_4 = [];
            foreach ($object->getRecipientSignatureProviders() as $value_4) {
                $values_4[] = $this->serializer->serialize($value_4, 'raw', $context);
            }
            $data->{'recipientSignatureProviders'} = $values_4;
        }
        ...
        if (null !== $object->getSigningGroupUsers()) {
            $values_5 = [];
            foreach ($object->getSigningGroupUsers() as $value_5) {
                $values_5[] = $this->serializer->serialize($value_5, 'raw', $context);
            }
            $data->{'signingGroupUsers'} = $values_5;
        }
        ...
        if (null !== $object->getSocialAuthentications()) {
            $values_6 = [];
            foreach ($object->getSocialAuthentications() as $value_6) {
                $values_6[] = $this->serializer->serialize($value_6, 'raw', $context);
            }
            $data->{'socialAuthentications'} = $values_6;
        }
