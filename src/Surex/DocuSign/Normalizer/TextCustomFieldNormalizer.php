...
class TextCustomFieldNormalizer extends SerializerAwareNormalizer implements DenormalizerInterface, NormalizerInterface
{
    public function supportsDenormalization($data, $type, $format = null)
    {
        if ('Surex\\DocuSign\\Model\\TextCustomField' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Surex\DocuSign\Model\TextCustomField) {
            return true;
        }
    ...
    {
        $object = new \Surex\DocuSign\Model\TextCustomField();
