...
class RecipientAttachmentNormalizer extends SerializerAwareNormalizer implements DenormalizerInterface, NormalizerInterface
{
    public function supportsDenormalization($data, $type, $format = null)
    {
        if ('Surex\\DocuSign\\Model\\RecipientAttachment' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Surex\DocuSign\Model\RecipientAttachment) {
            return true;
        }
    ...
    {
        $object = new \Surex\DocuSign\Model\RecipientAttachment();
