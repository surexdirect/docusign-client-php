...
class CaptiveRecipientNormalizer extends SerializerAwareNormalizer implements DenormalizerInterface, NormalizerInterface
{
    public function supportsDenormalization($data, $type, $format = null)
    {
        if ('Surex\\DocuSign\\Model\\CaptiveRecipient' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Surex\DocuSign\Model\CaptiveRecipient) {
            return true;
        }
    ...
    {
        $object = new \Surex\DocuSign\Model\CaptiveRecipient();
