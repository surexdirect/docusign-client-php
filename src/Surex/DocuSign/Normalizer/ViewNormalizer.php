...
class ViewNormalizer extends SerializerAwareNormalizer implements DenormalizerInterface, NormalizerInterface
{
    public function supportsDenormalization($data, $type, $format = null)
    {
        if ('Surex\\DocuSign\\Model\\View' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Surex\DocuSign\Model\View) {
            return true;
        }
    ...
    {
        $object = new \Surex\DocuSign\Model\View();
        ...
        if (property_exists($data, 'requiredRead')) {
            $object->setRequiredRead($data->{'requiredRead'});
        }
    ...
    public function normalize($object, $format = null, array $context = [])
    {
        ...
        if (null !== $object->getRequiredRead()) {
            $data->{'requiredRead'} = $object->getRequiredRead();
        }
