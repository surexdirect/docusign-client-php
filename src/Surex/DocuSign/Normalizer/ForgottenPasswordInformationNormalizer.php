...
class ForgottenPasswordInformationNormalizer extends SerializerAwareNormalizer implements DenormalizerInterface, NormalizerInterface
{
    public function supportsDenormalization($data, $type, $format = null)
    {
        if ('Surex\\DocuSign\\Model\\ForgottenPasswordInformation' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Surex\DocuSign\Model\ForgottenPasswordInformation) {
            return true;
        }
    ...
    {
        $object = new \Surex\DocuSign\Model\ForgottenPasswordInformation();
