...
class AuthenticationStatusNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Surex\\DocuSign\\Model\\AuthenticationStatus' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Surex\DocuSign\Model\AuthenticationStatus;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (property_exists($data, 'accessCodeResult')) {
            $object->setAccessCodeResult($this->denormalizer->denormalize($data->{'accessCodeResult'}, 'Surex\\DocuSign\\Model\\EventResult', 'json', $context));
        }
        if (property_exists($data, 'ageVerifyResult')) {
            $object->setAgeVerifyResult($this->denormalizer->denormalize($data->{'ageVerifyResult'}, 'Surex\\DocuSign\\Model\\EventResult', 'json', $context));
        }
        if (property_exists($data, 'anySocialIDResult')) {
            $object->setAnySocialIDResult($this->denormalizer->denormalize($data->{'anySocialIDResult'}, 'Surex\\DocuSign\\Model\\EventResult', 'json', $context));
        }
        if (property_exists($data, 'facebookResult')) {
            $object->setFacebookResult($this->denormalizer->denormalize($data->{'facebookResult'}, 'Surex\\DocuSign\\Model\\EventResult', 'json', $context));
        }
        if (property_exists($data, 'googleResult')) {
            $object->setGoogleResult($this->denormalizer->denormalize($data->{'googleResult'}, 'Surex\\DocuSign\\Model\\EventResult', 'json', $context));
        }
        if (property_exists($data, 'idLookupResult')) {
            $object->setIdLookupResult($this->denormalizer->denormalize($data->{'idLookupResult'}, 'Surex\\DocuSign\\Model\\EventResult', 'json', $context));
        }
        if (property_exists($data, 'idQuestionsResult')) {
            $object->setIdQuestionsResult($this->denormalizer->denormalize($data->{'idQuestionsResult'}, 'Surex\\DocuSign\\Model\\EventResult', 'json', $context));
        }
        if (property_exists($data, 'linkedinResult')) {
            $object->setLinkedinResult($this->denormalizer->denormalize($data->{'linkedinResult'}, 'Surex\\DocuSign\\Model\\EventResult', 'json', $context));
        }
        if (property_exists($data, 'liveIDResult')) {
            $object->setLiveIDResult($this->denormalizer->denormalize($data->{'liveIDResult'}, 'Surex\\DocuSign\\Model\\EventResult', 'json', $context));
        }
        if (property_exists($data, 'ofacResult')) {
            $object->setOfacResult($this->denormalizer->denormalize($data->{'ofacResult'}, 'Surex\\DocuSign\\Model\\EventResult', 'json', $context));
        }
        if (property_exists($data, 'openIDResult')) {
            $object->setOpenIDResult($this->denormalizer->denormalize($data->{'openIDResult'}, 'Surex\\DocuSign\\Model\\EventResult', 'json', $context));
        }
        if (property_exists($data, 'phoneAuthResult')) {
            $object->setPhoneAuthResult($this->denormalizer->denormalize($data->{'phoneAuthResult'}, 'Surex\\DocuSign\\Model\\EventResult', 'json', $context));
        }
        if (property_exists($data, 'salesforceResult')) {
            $object->setSalesforceResult($this->denormalizer->denormalize($data->{'salesforceResult'}, 'Surex\\DocuSign\\Model\\EventResult', 'json', $context));
        }
        if (property_exists($data, 'signatureProviderResult')) {
            $object->setSignatureProviderResult($this->denormalizer->denormalize($data->{'signatureProviderResult'}, 'Surex\\DocuSign\\Model\\EventResult', 'json', $context));
        }
        if (property_exists($data, 'smsAuthResult')) {
            $object->setSmsAuthResult($this->denormalizer->denormalize($data->{'smsAuthResult'}, 'Surex\\DocuSign\\Model\\EventResult', 'json', $context));
        }
        if (property_exists($data, 'sTANPinResult')) {
            $object->setSTANPinResult($this->denormalizer->denormalize($data->{'sTANPinResult'}, 'Surex\\DocuSign\\Model\\EventResult', 'json', $context));
        }
        if (property_exists($data, 'twitterResult')) {
            $object->setTwitterResult($this->denormalizer->denormalize($data->{'twitterResult'}, 'Surex\\DocuSign\\Model\\EventResult', 'json', $context));
        }
        if (property_exists($data, 'yahooResult')) {
            $object->setYahooResult($this->denormalizer->denormalize($data->{'yahooResult'}, 'Surex\\DocuSign\\Model\\EventResult', 'json', $context));
        }
