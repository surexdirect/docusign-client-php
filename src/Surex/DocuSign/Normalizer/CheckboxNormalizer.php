...
class CheckboxNormalizer extends SerializerAwareNormalizer implements DenormalizerInterface, NormalizerInterface
{
    public function supportsDenormalization($data, $type, $format = null)
    {
        if ('Surex\\DocuSign\\Model\\Checkbox' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Surex\DocuSign\Model\Checkbox) {
            return true;
        }
    ...
    {
        $object = new \Surex\DocuSign\Model\Checkbox();
