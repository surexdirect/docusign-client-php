...
class EnvelopeRecipientTabsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Surex\\DocuSign\\Model\\EnvelopeRecipientTabs' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Surex\DocuSign\Model\EnvelopeRecipientTabs;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Surex\DocuSign\Model\EnvelopeRecipientTabs();
        if (property_exists($data, 'approveTabs')) {
            $values = [];
            foreach ($data->{'approveTabs'} as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Surex\\DocuSign\\Model\\Approve', 'json', $context);
            }
        ...
        if (property_exists($data, 'checkboxTabs')) {
            ...
            foreach ($data->{'checkboxTabs'} as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Surex\\DocuSign\\Model\\Checkbox', 'json', $context);
            }
        ...
        if (property_exists($data, 'companyTabs')) {
            ...
            foreach ($data->{'companyTabs'} as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'Surex\\DocuSign\\Model\\Company', 'json', $context);
            }
        ...
        if (property_exists($data, 'dateSignedTabs')) {
            ...
            foreach ($data->{'dateSignedTabs'} as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, 'Surex\\DocuSign\\Model\\DateSigned', 'json', $context);
            }
        ...
        if (property_exists($data, 'dateTabs')) {
            ...
            foreach ($data->{'dateTabs'} as $value_4) {
                $values_4[] = $this->denormalizer->denormalize($value_4, 'Surex\\DocuSign\\Model\\Date', 'json', $context);
            }
        ...
        if (property_exists($data, 'declineTabs')) {
            ...
            foreach ($data->{'declineTabs'} as $value_5) {
                $values_5[] = $this->denormalizer->denormalize($value_5, 'Surex\\DocuSign\\Model\\Decline', 'json', $context);
            }
        ...
        if (property_exists($data, 'emailAddressTabs')) {
            ...
            foreach ($data->{'emailAddressTabs'} as $value_6) {
                $values_6[] = $this->denormalizer->denormalize($value_6, 'Surex\\DocuSign\\Model\\EmailAddress', 'json', $context);
            }
        ...
        if (property_exists($data, 'emailTabs')) {
            ...
            foreach ($data->{'emailTabs'} as $value_7) {
                $values_7[] = $this->denormalizer->denormalize($value_7, 'Surex\\DocuSign\\Model\\Email', 'json', $context);
            }
        ...
        if (property_exists($data, 'envelopeIdTabs')) {
            ...
            foreach ($data->{'envelopeIdTabs'} as $value_8) {
                $values_8[] = $this->denormalizer->denormalize($value_8, 'Surex\\DocuSign\\Model\\EnvelopeId', 'json', $context);
            }
        ...
        if (property_exists($data, 'firstNameTabs')) {
            ...
            foreach ($data->{'firstNameTabs'} as $value_9) {
                $values_9[] = $this->denormalizer->denormalize($value_9, 'Surex\\DocuSign\\Model\\FirstName', 'json', $context);
            }
        ...
        if (property_exists($data, 'formulaTabs')) {
            ...
            foreach ($data->{'formulaTabs'} as $value_10) {
                $values_10[] = $this->denormalizer->denormalize($value_10, 'Surex\\DocuSign\\Model\\FormulaTab', 'json', $context);
            }
        ...
        if (property_exists($data, 'fullNameTabs')) {
            ...
            foreach ($data->{'fullNameTabs'} as $value_11) {
                $values_11[] = $this->denormalizer->denormalize($value_11, 'Surex\\DocuSign\\Model\\FullName', 'json', $context);
            }
        ...
        if (property_exists($data, 'initialHereTabs')) {
            ...
            foreach ($data->{'initialHereTabs'} as $value_12) {
                $values_12[] = $this->denormalizer->denormalize($value_12, 'Surex\\DocuSign\\Model\\InitialHere', 'json', $context);
            }
        ...
        if (property_exists($data, 'lastNameTabs')) {
            ...
            foreach ($data->{'lastNameTabs'} as $value_13) {
                $values_13[] = $this->denormalizer->denormalize($value_13, 'Surex\\DocuSign\\Model\\LastName', 'json', $context);
            }
        ...
        if (property_exists($data, 'listTabs')) {
            ...
            foreach ($data->{'listTabs'} as $value_14) {
                $values_14[] = $this->denormalizer->denormalize($value_14, 'Surex\\DocuSign\\Model\\_List', 'json', $context);
            }
        ...
        if (property_exists($data, 'noteTabs')) {
            ...
            foreach ($data->{'noteTabs'} as $value_15) {
                $values_15[] = $this->denormalizer->denormalize($value_15, 'Surex\\DocuSign\\Model\\Note', 'json', $context);
            }
        ...
        if (property_exists($data, 'numberTabs')) {
            ...
            foreach ($data->{'numberTabs'} as $value_16) {
                $values_16[] = $this->denormalizer->denormalize($value_16, 'Surex\\DocuSign\\Model\\Number', 'json', $context);
            }
        ...
        if (property_exists($data, 'radioGroupTabs')) {
            ...
            foreach ($data->{'radioGroupTabs'} as $value_17) {
                $values_17[] = $this->denormalizer->denormalize($value_17, 'Surex\\DocuSign\\Model\\RadioGroup', 'json', $context);
            }
        ...
        if (property_exists($data, 'signerAttachmentTabs')) {
            ...
            foreach ($data->{'signerAttachmentTabs'} as $value_18) {
                $values_18[] = $this->denormalizer->denormalize($value_18, 'Surex\\DocuSign\\Model\\SignerAttachment', 'json', $context);
            }
        ...
        if (property_exists($data, 'signHereTabs')) {
            ...
            foreach ($data->{'signHereTabs'} as $value_19) {
                $values_19[] = $this->denormalizer->denormalize($value_19, 'Surex\\DocuSign\\Model\\SignHere', 'json', $context);
            }
        ...
        if (property_exists($data, 'ssnTabs')) {
            ...
            foreach ($data->{'ssnTabs'} as $value_20) {
                $values_20[] = $this->denormalizer->denormalize($value_20, 'Surex\\DocuSign\\Model\\Ssn', 'json', $context);
            }
        ...
        if (property_exists($data, 'textTabs')) {
            ...
            foreach ($data->{'textTabs'} as $value_21) {
                $values_21[] = $this->denormalizer->denormalize($value_21, 'Surex\\DocuSign\\Model\\Text', 'json', $context);
            }
        ...
        if (property_exists($data, 'titleTabs')) {
            ...
            foreach ($data->{'titleTabs'} as $value_22) {
                $values_22[] = $this->denormalizer->denormalize($value_22, 'Surex\\DocuSign\\Model\\Title', 'json', $context);
            }
        ...
        if (property_exists($data, 'viewTabs')) {
            ...
            foreach ($data->{'viewTabs'} as $value_23) {
                $values_23[] = $this->denormalizer->denormalize($value_23, 'Surex\\DocuSign\\Model\\View', 'json', $context);
            }
        ...
        if (property_exists($data, 'zipTabs')) {
            ...
            foreach ($data->{'zipTabs'} as $value_24) {
                $values_24[] = $this->denormalizer->denormalize($value_24, 'Surex\\DocuSign\\Model\\Zip', 'json', $context);
            }
