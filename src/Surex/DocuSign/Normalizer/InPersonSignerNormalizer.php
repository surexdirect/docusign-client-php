...
class InPersonSignerNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Surex\\DocuSign\\Model\\InPersonSigner' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Surex\DocuSign\Model\InPersonSigner;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (property_exists($data, 'notaryHost')) {
            $object->setNotaryHost($this->denormalizer->denormalize($data->{'notaryHost'}, 'Surex\\DocuSign\\Model\\NotaryHost', 'json', $context));
        }
        ...
        if (property_exists($data, 'recipientSignatureProviders')) {
            ...
            foreach ($data->{'recipientSignatureProviders'} as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, 'Surex\\DocuSign\\Model\\RecipientSignatureProvider', 'json', $context);
            }
