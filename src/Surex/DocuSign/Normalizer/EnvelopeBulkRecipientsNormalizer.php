...
class EnvelopeBulkRecipientsNormalizer extends SerializerAwareNormalizer implements DenormalizerInterface, NormalizerInterface
{
    public function supportsDenormalization($data, $type, $format = null)
    {
        if ('Surex\\DocuSign\\Model\\EnvelopeBulkRecipients' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Surex\DocuSign\Model\EnvelopeBulkRecipients) {
            return true;
        }
    ...
    {
        $object = new \Surex\DocuSign\Model\EnvelopeBulkRecipients();
