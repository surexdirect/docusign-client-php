...
class ConnectConfigurationsNormalizer extends SerializerAwareNormalizer implements DenormalizerInterface, NormalizerInterface
{
    public function supportsDenormalization($data, $type, $format = null)
    {
        if ('Surex\\DocuSign\\Model\\ConnectConfigurations' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Surex\DocuSign\Model\ConnectConfigurations) {
            return true;
        }
    ...
    {
        $object = new \Surex\DocuSign\Model\ConnectConfigurations();
