...
class CreditCardTypesNormalizer extends SerializerAwareNormalizer implements DenormalizerInterface, NormalizerInterface
{
    public function supportsDenormalization($data, $type, $format = null)
    {
        if ('Surex\\DocuSign\\Model\\CreditCardTypes' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Surex\DocuSign\Model\CreditCardTypes) {
            return true;
        }
