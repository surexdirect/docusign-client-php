...
class FormulaTab
{
     ...
     * @return self
     */
    public function setIsPaymentAmount($isPaymentAmount = null)
    {
     ...
     * @return self
     */
    public function setPaymentDetails(PaymentDetails $paymentDetails = null)
    {
     ...
     * @return self
     */
    public function setRoundDecimalPlaces($roundDecimalPlaces = null)
    {
