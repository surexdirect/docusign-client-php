...
class FormulaTab
{
     ...
     * @return string
     */
    public function getIsPaymentAmount(): ?string
    {
     ...
     * @return self
     */
    public function setIsPaymentAmount(?string $isPaymentAmount): self
    {
     ...
     * @return string
     */
    public function getRoundDecimalPlaces(): ?string
    {
     ...
     * @return self
     */
    public function setRoundDecimalPlaces(?string $roundDecimalPlaces): self
    {
