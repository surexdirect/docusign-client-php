...
class PowerFormSendersResponse
{
     ...
     * @return UserInfo[]
     */
    public function getPowerFormSenders(): ?array
    {
        return $this->powerFormSenders;
    }

    /**
     * @param UserInfo[] $powerFormSenders
     *
     * @return self
     */
    public function setPowerFormSenders(?array $powerFormSenders): self
    {
