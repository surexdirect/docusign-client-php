...
class EditorNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Surex\\DocuSign\\Generated\\Model\\Editor' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Surex\DocuSign\Generated\Model\Editor;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Surex\DocuSign\Generated\Model\Editor();
        ...
        if (property_exists($data, 'signingGroupUsers')) {
            ...
            foreach ($data->{'signingGroupUsers'} as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, 'Surex\\DocuSign\\Generated\\Model\\UserInfo', 'json', $context);
            }
        ...
        if (property_exists($data, 'socialAuthentications')) {
            ...
            foreach ($data->{'socialAuthentications'} as $value_4) {
                $values_4[] = $this->denormalizer->denormalize($value_4, 'Surex\\DocuSign\\Generated\\Model\\SocialAuthentication', 'json', $context);
            }
