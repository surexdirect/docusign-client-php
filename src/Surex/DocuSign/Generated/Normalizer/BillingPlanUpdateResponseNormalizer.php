...
class BillingPlanUpdateResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Surex\\DocuSign\\Generated\\Model\\BillingPlanUpdateResponse' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Surex\DocuSign\Generated\Model\BillingPlanUpdateResponse;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Surex\DocuSign\Generated\Model\BillingPlanUpdateResponse();
        ...
        if (property_exists($data, 'billingPlanPreview')) {
            $object->setBillingPlanPreview($this->denormalizer->denormalize($data->{'billingPlanPreview'}, 'Surex\\DocuSign\\Generated\\Model\\BillingPlanPreview', 'json', $context));
        }
