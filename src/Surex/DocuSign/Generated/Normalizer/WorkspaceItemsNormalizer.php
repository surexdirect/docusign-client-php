...
class WorkspaceItemsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Surex\\DocuSign\\Generated\\Model\\WorkspaceItems' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Surex\DocuSign\Generated\Model\WorkspaceItems;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Surex\DocuSign\Generated\Model\WorkspaceItems();
        if (property_exists($data, 'callerAuthorization')) {
            $object->setCallerAuthorization($this->denormalizer->denormalize($data->{'callerAuthorization'}, 'Surex\\DocuSign\\Generated\\Model\\WorkspaceUserAuthorization', 'json', $context));
        }
        ...
        if (property_exists($data, 'createdByInformation')) {
            $object->setCreatedByInformation($this->denormalizer->denormalize($data->{'createdByInformation'}, 'Surex\\DocuSign\\Generated\\Model\\WorkspaceUser', 'json', $context));
        }
        ...
        if (property_exists($data, 'lastModifiedByInformation')) {
            $object->setLastModifiedByInformation($this->denormalizer->denormalize($data->{'lastModifiedByInformation'}, 'Surex\\DocuSign\\Generated\\Model\\WorkspaceUser', 'json', $context));
        }
