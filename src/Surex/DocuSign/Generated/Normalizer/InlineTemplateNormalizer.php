...
class InlineTemplateNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Surex\\DocuSign\\Generated\\Model\\InlineTemplate' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Surex\DocuSign\Generated\Model\InlineTemplate;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Surex\DocuSign\Generated\Model\InlineTemplate();
        ...
        if (property_exists($data, 'envelope')) {
            $object->setEnvelope($this->denormalizer->denormalize($data->{'envelope'}, 'Surex\\DocuSign\\Generated\\Model\\Envelopes', 'json', $context));
        }
