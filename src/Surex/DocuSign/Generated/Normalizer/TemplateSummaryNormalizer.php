...
class TemplateSummaryNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Surex\\DocuSign\\Generated\\Model\\TemplateSummary' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Surex\DocuSign\Generated\Model\TemplateSummary;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Surex\DocuSign\Generated\Model\TemplateSummary();
        ...
        if (property_exists($data, 'templateMatch')) {
            $object->setTemplateMatch($this->denormalizer->denormalize($data->{'templateMatch'}, 'Surex\\DocuSign\\Generated\\Model\\TemplateMatch', 'json', $context));
        }
