...
class BillingPlanInformationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Surex\\DocuSign\\Generated\\Model\\BillingPlanInformation' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Surex\DocuSign\Generated\Model\BillingPlanInformation;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Surex\DocuSign\Generated\Model\BillingPlanInformation();
        if (property_exists($data, 'appStoreReceipt')) {
            $object->setAppStoreReceipt($this->denormalizer->denormalize($data->{'appStoreReceipt'}, 'Surex\\DocuSign\\Generated\\Model\\AppStoreReceipt', 'json', $context));
        }
