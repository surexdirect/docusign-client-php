...
class EventNotificationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Surex\\DocuSign\\Generated\\Model\\EventNotification' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Surex\DocuSign\Generated\Model\EventNotification;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Surex\DocuSign\Generated\Model\EventNotification();
        if (property_exists($data, 'envelopeEvents')) {
            $values = [];
            foreach ($data->{'envelopeEvents'} as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Surex\\DocuSign\\Generated\\Model\\EnvelopeEvent', 'json', $context);
            }
        ...
        if (property_exists($data, 'recipientEvents')) {
            ...
            foreach ($data->{'recipientEvents'} as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Surex\\DocuSign\\Generated\\Model\\RecipientEvent', 'json', $context);
            }
