...
class UserSettingsInformationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Surex\\DocuSign\\Generated\\Model\\UserSettingsInformation' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Surex\DocuSign\Generated\Model\UserSettingsInformation;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Surex\DocuSign\Generated\Model\UserSettingsInformation();
        ...
        if (property_exists($data, 'senderEmailNotifications')) {
            $object->setSenderEmailNotifications($this->denormalizer->denormalize($data->{'senderEmailNotifications'}, 'Surex\\DocuSign\\Generated\\Model\\SenderEmailNotifications', 'json', $context));
        }
        if (property_exists($data, 'signerEmailNotifications')) {
            $object->setSignerEmailNotifications($this->denormalizer->denormalize($data->{'signerEmailNotifications'}, 'Surex\\DocuSign\\Generated\\Model\\SignerEmailNotifications', 'json', $context));
        }
