...
class AccountConsumerDisclosuresNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Surex\\DocuSign\\Generated\\Model\\AccountConsumerDisclosures' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Surex\DocuSign\Generated\Model\AccountConsumerDisclosures;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Surex\DocuSign\Generated\Model\AccountConsumerDisclosures();
        ...
        if (property_exists($data, 'allowCDWithdrawMetadata')) {
            $object->setAllowCDWithdrawMetadata($this->denormalizer->denormalize($data->{'allowCDWithdrawMetadata'}, 'Surex\\DocuSign\\Generated\\Model\\SettingsMetadata', 'json', $context));
        }
        ...
        if (property_exists($data, 'useConsumerDisclosureWithinAccountMetadata')) {
            $object->setUseConsumerDisclosureWithinAccountMetadata($this->denormalizer->denormalize($data->{'useConsumerDisclosureWithinAccountMetadata'}, 'Surex\\DocuSign\\Generated\\Model\\SettingsMetadata', 'json', $context));
        }
