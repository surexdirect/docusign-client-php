...
class MemberGroupSharedItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Surex\\DocuSign\\Generated\\Model\\MemberGroupSharedItem' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Surex\DocuSign\Generated\Model\MemberGroupSharedItem;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Surex\DocuSign\Generated\Model\MemberGroupSharedItem();
        ...
        if (property_exists($data, 'group')) {
            $object->setGroup($this->denormalizer->denormalize($data->{'group'}, 'Surex\\DocuSign\\Generated\\Model\\Group', 'json', $context));
        }
