...
class EnvelopeTemplateDefinitionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Surex\\DocuSign\\Generated\\Model\\EnvelopeTemplateDefinition' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Surex\DocuSign\Generated\Model\EnvelopeTemplateDefinition;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Surex\DocuSign\Generated\Model\EnvelopeTemplateDefinition();
        ...
        if (property_exists($data, 'lastModifiedBy')) {
            $object->setLastModifiedBy($this->denormalizer->denormalize($data->{'lastModifiedBy'}, 'Surex\\DocuSign\\Generated\\Model\\UserInfo', 'json', $context));
        }
