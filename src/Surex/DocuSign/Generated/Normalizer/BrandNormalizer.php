...
class BrandNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Surex\\DocuSign\\Generated\\Model\\Brand' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Surex\DocuSign\Generated\Model\Brand;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Surex\DocuSign\Generated\Model\Brand();
        ...
        if (property_exists($data, 'emailContent')) {
            ...
            foreach ($data->{'emailContent'} as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Surex\\DocuSign\\Generated\\Model\\BrandEmailContent', 'json', $context);
            }
        ...
        if (property_exists($data, 'links')) {
            ...
            foreach ($data->{'links'} as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, 'Surex\\DocuSign\\Generated\\Model\\BrandLink', 'json', $context);
            }
            $object->setLinks($values_3);
        }
        if (property_exists($data, 'logos')) {
            $object->setLogos($this->denormalizer->denormalize($data->{'logos'}, 'Surex\\DocuSign\\Generated\\Model\\BrandLogos', 'json', $context));
        }
        if (property_exists($data, 'resources')) {
            $object->setResources($this->denormalizer->denormalize($data->{'resources'}, 'Surex\\DocuSign\\Generated\\Model\\BrandResourceUrls', 'json', $context));
        }
