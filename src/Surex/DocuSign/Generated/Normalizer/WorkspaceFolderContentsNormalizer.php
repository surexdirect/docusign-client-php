...
class WorkspaceFolderContentsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Surex\\DocuSign\\Generated\\Model\\WorkspaceFolderContents' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Surex\DocuSign\Generated\Model\WorkspaceFolderContents;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Surex\DocuSign\Generated\Model\WorkspaceFolderContents();
        if (property_exists($data, 'endPosition')) {
            $object->setEndPosition($data->{'endPosition'});
        }
        if (property_exists($data, 'folder')) {
            $object->setFolder($this->denormalizer->denormalize($data->{'folder'}, 'Surex\\DocuSign\\Generated\\Model\\WorkspaceItems', 'json', $context));
        }
        ...
        if (property_exists($data, 'parentFolders')) {
            ...
            foreach ($data->{'parentFolders'} as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Surex\\DocuSign\\Generated\\Model\\WorkspaceItems', 'json', $context);
            }
