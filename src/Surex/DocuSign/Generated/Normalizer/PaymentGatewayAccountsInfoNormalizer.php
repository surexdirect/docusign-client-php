...
class PaymentGatewayAccountsInfoNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Surex\\DocuSign\\Generated\\Model\\PaymentGatewayAccountsInfo' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Surex\DocuSign\Generated\Model\PaymentGatewayAccountsInfo;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Surex\DocuSign\Generated\Model\PaymentGatewayAccountsInfo();
        if (property_exists($data, 'paymentGatewayAccounts')) {
            $values = [];
            foreach ($data->{'paymentGatewayAccounts'} as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Surex\\DocuSign\\Generated\\Model\\PaymentGatewayAccounts', 'json', $context);
            }
