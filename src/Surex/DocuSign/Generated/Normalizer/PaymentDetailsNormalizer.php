...
class PaymentDetailsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Surex\\DocuSign\\Generated\\Model\\PaymentDetails' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Surex\DocuSign\Generated\Model\PaymentDetails;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Surex\DocuSign\Generated\Model\PaymentDetails();
        ...
        if (property_exists($data, 'lineItems')) {
            ...
            foreach ($data->{'lineItems'} as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Surex\\DocuSign\\Generated\\Model\\PaymentLineItem', 'json', $context);
            }
        ...
        if (property_exists($data, 'total')) {
            $object->setTotal($this->denormalizer->denormalize($data->{'total'}, 'Surex\\DocuSign\\Generated\\Model\\Money', 'json', $context));
        }
