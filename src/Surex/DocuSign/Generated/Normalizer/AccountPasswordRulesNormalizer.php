...
class AccountPasswordRulesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Surex\\DocuSign\\Generated\\Model\\AccountPasswordRules' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Surex\DocuSign\Generated\Model\AccountPasswordRules;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Surex\DocuSign\Generated\Model\AccountPasswordRules();
        ...
        if (property_exists($data, 'expirePasswordDaysMetadata')) {
            $object->setExpirePasswordDaysMetadata($this->denormalizer->denormalize($data->{'expirePasswordDaysMetadata'}, 'Surex\\DocuSign\\Generated\\Model\\AccountPasswordExpirePasswordDays', 'json', $context));
        }
        ...
        if (property_exists($data, 'lockoutDurationMinutesMetadata')) {
            $object->setLockoutDurationMinutesMetadata($this->denormalizer->denormalize($data->{'lockoutDurationMinutesMetadata'}, 'Surex\\DocuSign\\Generated\\Model\\AccountPasswordLockoutDurationMinutes', 'json', $context));
        }
        ...
        if (property_exists($data, 'lockoutDurationTypeMetadata')) {
            $object->setLockoutDurationTypeMetadata($this->denormalizer->denormalize($data->{'lockoutDurationTypeMetadata'}, 'Surex\\DocuSign\\Generated\\Model\\AccountPasswordLockoutDurationType', 'json', $context));
        }
        ...
        if (property_exists($data, 'minimumPasswordAgeDaysMetadata')) {
            $object->setMinimumPasswordAgeDaysMetadata($this->denormalizer->denormalize($data->{'minimumPasswordAgeDaysMetadata'}, 'Surex\\DocuSign\\Generated\\Model\\AccountPasswordMinimumPasswordAgeDays', 'json', $context));
        }
        ...
        if (property_exists($data, 'minimumPasswordLengthMetadata')) {
            $object->setMinimumPasswordLengthMetadata($this->denormalizer->denormalize($data->{'minimumPasswordLengthMetadata'}, 'Surex\\DocuSign\\Generated\\Model\\AccountMinimumPasswordLength', 'json', $context));
        }
        ...
        if (property_exists($data, 'passwordStrengthTypeMetadata')) {
            $object->setPasswordStrengthTypeMetadata($this->denormalizer->denormalize($data->{'passwordStrengthTypeMetadata'}, 'Surex\\DocuSign\\Generated\\Model\\AccountPasswordStrengthType', 'json', $context));
        }
        ...
        if (property_exists($data, 'questionsRequiredMetadata')) {
            $object->setQuestionsRequiredMetadata($this->denormalizer->denormalize($data->{'questionsRequiredMetadata'}, 'Surex\\DocuSign\\Generated\\Model\\AccountPasswordQuestionsRequired', 'json', $context));
        }
