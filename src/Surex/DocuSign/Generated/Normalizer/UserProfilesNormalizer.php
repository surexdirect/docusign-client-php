...
class UserProfilesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Surex\\DocuSign\\Generated\\Model\\UserProfiles' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Surex\DocuSign\Generated\Model\UserProfiles;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Surex\DocuSign\Generated\Model\UserProfiles();
        if (property_exists($data, 'address')) {
            $object->setAddress($this->denormalizer->denormalize($data->{'address'}, 'Surex\\DocuSign\\Generated\\Model\\AddressInformationV2', 'json', $context));
        }
        if (property_exists($data, 'authenticationMethods')) {
            $values = [];
            foreach ($data->{'authenticationMethods'} as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Surex\\DocuSign\\Generated\\Model\\AuthenticationMethod', 'json', $context);
            }
        ...
        if (property_exists($data, 'usageHistory')) {
            $object->setUsageHistory($this->denormalizer->denormalize($data->{'usageHistory'}, 'Surex\\DocuSign\\Generated\\Model\\UsageHistory', 'json', $context));
        }
        if (property_exists($data, 'userDetails')) {
            $object->setUserDetails($this->denormalizer->denormalize($data->{'userDetails'}, 'Surex\\DocuSign\\Generated\\Model\\Users', 'json', $context));
        }
