...
class UsersNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Surex\\DocuSign\\Generated\\Model\\Users' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Surex\DocuSign\Generated\Model\Users;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Surex\DocuSign\Generated\Model\Users();
        if (property_exists($data, 'accountManagementGranular')) {
            $object->setAccountManagementGranular($this->denormalizer->denormalize($data->{'accountManagementGranular'}, 'Surex\\DocuSign\\Generated\\Model\\UserAccountManagementGranularInformation', 'json', $context));
        }
        ...
        if (property_exists($data, 'groupList')) {
            ...
            foreach ($data->{'groupList'} as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Surex\\DocuSign\\Generated\\Model\\Group', 'json', $context);
            }
            $object->setGroupList($values_1);
        }
        if (property_exists($data, 'homeAddress')) {
            $object->setHomeAddress($this->denormalizer->denormalize($data->{'homeAddress'}, 'Surex\\DocuSign\\Generated\\Model\\AddressInformationV2', 'json', $context));
        }
        ...
        if (property_exists($data, 'userSettings')) {
            ...
            foreach ($data->{'userSettings'} as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'Surex\\DocuSign\\Generated\\Model\\NameValue', 'json', $context);
            }
        ...
        if (property_exists($data, 'workAddress')) {
            $object->setWorkAddress($this->denormalizer->denormalize($data->{'workAddress'}, 'Surex\\DocuSign\\Generated\\Model\\AddressInformationV2', 'json', $context));
        }
