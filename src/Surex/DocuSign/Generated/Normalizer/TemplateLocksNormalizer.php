...
class TemplateLocksNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Surex\\DocuSign\\Generated\\Model\\TemplateLocks' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Surex\DocuSign\Generated\Model\TemplateLocks;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Surex\DocuSign\Generated\Model\TemplateLocks();
        ...
        if (property_exists($data, 'lockedByUser')) {
            $object->setLockedByUser($this->denormalizer->denormalize($data->{'lockedByUser'}, 'Surex\\DocuSign\\Generated\\Model\\UserInfo', 'json', $context));
        }
