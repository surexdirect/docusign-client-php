...
class CurrencyPlanPriceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Surex\\DocuSign\\Generated\\Model\\CurrencyPlanPrice' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Surex\DocuSign\Generated\Model\CurrencyPlanPrice;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Surex\DocuSign\Generated\Model\CurrencyPlanPrice();
        ...
        if (property_exists($data, 'supportedCardTypes')) {
            $object->setSupportedCardTypes($this->denormalizer->denormalize($data->{'supportedCardTypes'}, 'Surex\\DocuSign\\Generated\\Model\\CreditCardTypes', 'json', $context));
        }
