...
class AddressInformationInputNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Surex\\DocuSign\\Generated\\Model\\AddressInformationInput' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Surex\DocuSign\Generated\Model\AddressInformationInput;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Surex\DocuSign\Generated\Model\AddressInformationInput();
        if (property_exists($data, 'addressInformation')) {
            $object->setAddressInformation($this->denormalizer->denormalize($data->{'addressInformation'}, 'Surex\\DocuSign\\Generated\\Model\\AddressInformation', 'json', $context));
        }
