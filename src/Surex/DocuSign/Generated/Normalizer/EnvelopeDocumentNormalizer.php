...
class EnvelopeDocumentNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Surex\\DocuSign\\Generated\\Model\\EnvelopeDocument' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Surex\DocuSign\Generated\Model\EnvelopeDocument;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Surex\DocuSign\Generated\Model\EnvelopeDocument();
        ...
        if (property_exists($data, 'availableDocumentTypes')) {
            ...
            foreach ($data->{'availableDocumentTypes'} as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Surex\\DocuSign\\Generated\\Model\\SignatureType', 'json', $context);
            }
        ...
        if (property_exists($data, 'documentFields')) {
            ...
            foreach ($data->{'documentFields'} as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Surex\\DocuSign\\Generated\\Model\\NameValue', 'json', $context);
            }
