...
class AccountBillingPlanNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Surex\\DocuSign\\Generated\\Model\\AccountBillingPlan' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Surex\DocuSign\Generated\Model\AccountBillingPlan;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Surex\DocuSign\Generated\Model\AccountBillingPlan();
        if (property_exists($data, 'addOns')) {
            $values = [];
            foreach ($data->{'addOns'} as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Surex\\DocuSign\\Generated\\Model\\AddOn', 'json', $context);
            }
        ...
        if (property_exists($data, 'planFeatureSets')) {
            ...
            foreach ($data->{'planFeatureSets'} as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Surex\\DocuSign\\Generated\\Model\\FeatureSet', 'json', $context);
            }
        ...
        if (property_exists($data, 'seatDiscounts')) {
            ...
            foreach ($data->{'seatDiscounts'} as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'Surex\\DocuSign\\Generated\\Model\\SeatDiscount', 'json', $context);
            }
