...
class CompositeTemplateNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Surex\\DocuSign\\Generated\\Model\\CompositeTemplate' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Surex\DocuSign\Generated\Model\CompositeTemplate;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Surex\DocuSign\Generated\Model\CompositeTemplate();
        ...
        if (property_exists($data, 'document')) {
            $object->setDocument($this->denormalizer->denormalize($data->{'document'}, 'Surex\\DocuSign\\Generated\\Model\\Document', 'json', $context));
        }
        if (property_exists($data, 'inlineTemplates')) {
            $values = [];
            foreach ($data->{'inlineTemplates'} as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Surex\\DocuSign\\Generated\\Model\\InlineTemplate', 'json', $context);
            }
        ...
        if (property_exists($data, 'serverTemplates')) {
            ...
            foreach ($data->{'serverTemplates'} as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Surex\\DocuSign\\Generated\\Model\\ServerTemplate', 'json', $context);
            }
