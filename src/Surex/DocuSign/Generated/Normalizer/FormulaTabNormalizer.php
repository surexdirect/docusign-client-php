...
class FormulaTabNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Surex\\DocuSign\\Generated\\Model\\FormulaTab' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Surex\DocuSign\Generated\Model\FormulaTab;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Surex\DocuSign\Generated\Model\FormulaTab();
        ...
        if (property_exists($data, 'isPaymentAmount')) {
            $object->setIsPaymentAmount($data->{'isPaymentAmount'});
        }
        ...
        if (property_exists($data, 'paymentDetails')) {
            $object->setPaymentDetails($this->denormalizer->denormalize($data->{'paymentDetails'}, 'Surex\\DocuSign\\Generated\\Model\\PaymentDetails', 'json', $context));
        }
        ...
        if (property_exists($data, 'roundDecimalPlaces')) {
            $object->setRoundDecimalPlaces($data->{'roundDecimalPlaces'});
        }
    ...
    public function normalize($object, $format = null, array $context = [])
    {
        ...
        if (null !== $object->getIsPaymentAmount()) {
            $data->{'isPaymentAmount'} = $object->getIsPaymentAmount();
        }
        ...
        if (null !== $object->getRoundDecimalPlaces()) {
            $data->{'roundDecimalPlaces'} = $object->getRoundDecimalPlaces();
        }
