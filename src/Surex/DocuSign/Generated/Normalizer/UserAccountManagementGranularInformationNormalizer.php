...
class UserAccountManagementGranularInformationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Surex\\DocuSign\\Generated\\Model\\UserAccountManagementGranularInformation' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Surex\DocuSign\Generated\Model\UserAccountManagementGranularInformation;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Surex\DocuSign\Generated\Model\UserAccountManagementGranularInformation();
        ...
        if (property_exists($data, 'canManageAdminsMetadata')) {
            $object->setCanManageAdminsMetadata($this->denormalizer->denormalize($data->{'canManageAdminsMetadata'}, 'Surex\\DocuSign\\Generated\\Model\\SettingsMetadata', 'json', $context));
        }
        ...
        if (property_exists($data, 'canManageGroupsMetadata')) {
            $object->setCanManageGroupsMetadata($this->denormalizer->denormalize($data->{'canManageGroupsMetadata'}, 'Surex\\DocuSign\\Generated\\Model\\SettingsMetadata', 'json', $context));
        }
        ...
        if (property_exists($data, 'canManageSharingMetadata')) {
            $object->setCanManageSharingMetadata($this->denormalizer->denormalize($data->{'canManageSharingMetadata'}, 'Surex\\DocuSign\\Generated\\Model\\SettingsMetadata', 'json', $context));
        }
        ...
        if (property_exists($data, 'canManageUsersMetadata')) {
            $object->setCanManageUsersMetadata($this->denormalizer->denormalize($data->{'canManageUsersMetadata'}, 'Surex\\DocuSign\\Generated\\Model\\SettingsMetadata', 'json', $context));
        }
