...
class TemplateRecipientsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Surex\\DocuSign\\Generated\\Model\\TemplateRecipients' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Surex\DocuSign\Generated\Model\TemplateRecipients;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Surex\DocuSign\Generated\Model\TemplateRecipients();
        if (property_exists($data, 'agents')) {
            $values = [];
            foreach ($data->{'agents'} as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Surex\\DocuSign\\Generated\\Model\\Agent', 'json', $context);
            }
        ...
        if (property_exists($data, 'carbonCopies')) {
            ...
            foreach ($data->{'carbonCopies'} as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Surex\\DocuSign\\Generated\\Model\\CarbonCopy', 'json', $context);
            }
        ...
        if (property_exists($data, 'certifiedDeliveries')) {
            ...
            foreach ($data->{'certifiedDeliveries'} as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'Surex\\DocuSign\\Generated\\Model\\CertifiedDelivery', 'json', $context);
            }
        ...
        if (property_exists($data, 'editors')) {
            ...
            foreach ($data->{'editors'} as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, 'Surex\\DocuSign\\Generated\\Model\\Editor', 'json', $context);
            }
        ...
        if (property_exists($data, 'inPersonSigners')) {
            ...
            foreach ($data->{'inPersonSigners'} as $value_4) {
                $values_4[] = $this->denormalizer->denormalize($value_4, 'Surex\\DocuSign\\Generated\\Model\\InPersonSigner', 'json', $context);
            }
        ...
        if (property_exists($data, 'intermediaries')) {
            ...
            foreach ($data->{'intermediaries'} as $value_5) {
                $values_5[] = $this->denormalizer->denormalize($value_5, 'Surex\\DocuSign\\Generated\\Model\\Intermediary', 'json', $context);
            }
        ...
        if (property_exists($data, 'signers')) {
            ...
            foreach ($data->{'signers'} as $value_6) {
                $values_6[] = $this->denormalizer->denormalize($value_6, 'Surex\\DocuSign\\Generated\\Model\\Signer', 'json', $context);
            }
