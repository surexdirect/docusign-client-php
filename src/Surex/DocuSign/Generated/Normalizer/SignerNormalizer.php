...
class SignerNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Surex\\DocuSign\\Generated\\Model\\Signer' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Surex\DocuSign\Generated\Model\Signer;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Surex\DocuSign\Generated\Model\Signer();
        ...
        if (property_exists($data, 'recipientAttachments')) {
            ...
            foreach ($data->{'recipientAttachments'} as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, 'Surex\\DocuSign\\Generated\\Model\\RecipientAttachment', 'json', $context);
            }
        ...
        if (property_exists($data, 'recipientSignatureProviders')) {
            ...
            foreach ($data->{'recipientSignatureProviders'} as $value_4) {
                $values_4[] = $this->denormalizer->denormalize($value_4, 'Surex\\DocuSign\\Generated\\Model\\RecipientSignatureProvider', 'json', $context);
            }
        ...
        if (property_exists($data, 'signingGroupUsers')) {
            ...
            foreach ($data->{'signingGroupUsers'} as $value_5) {
                $values_5[] = $this->denormalizer->denormalize($value_5, 'Surex\\DocuSign\\Generated\\Model\\UserInfo', 'json', $context);
            }
        ...
        if (property_exists($data, 'socialAuthentications')) {
            ...
            foreach ($data->{'socialAuthentications'} as $value_6) {
                $values_6[] = $this->denormalizer->denormalize($value_6, 'Surex\\DocuSign\\Generated\\Model\\SocialAuthentication', 'json', $context);
            }
