...
class EnvelopeDefinitionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Surex\\DocuSign\\Generated\\Model\\EnvelopeDefinition' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Surex\DocuSign\Generated\Model\EnvelopeDefinition;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Surex\DocuSign\Generated\Model\EnvelopeDefinition();
        ...
        if (property_exists($data, 'attachments')) {
            ...
            foreach ($data->{'attachments'} as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Surex\\DocuSign\\Generated\\Model\\Attachment', 'json', $context);
            }
        ...
        if (property_exists($data, 'compositeTemplates')) {
            ...
            foreach ($data->{'compositeTemplates'} as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Surex\\DocuSign\\Generated\\Model\\CompositeTemplate', 'json', $context);
            }
        ...
        if (property_exists($data, 'documents')) {
            ...
            foreach ($data->{'documents'} as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'Surex\\DocuSign\\Generated\\Model\\Document', 'json', $context);
            }
        ...
        if (property_exists($data, 'eventNotification')) {
            $object->setEventNotification($this->denormalizer->denormalize($data->{'eventNotification'}, 'Surex\\DocuSign\\Generated\\Model\\EventNotification', 'json', $context));
        }
        ...
        if (property_exists($data, 'templateRoles')) {
            ...
            foreach ($data->{'templateRoles'} as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, 'Surex\\DocuSign\\Generated\\Model\\TemplateRole', 'json', $context);
            }
