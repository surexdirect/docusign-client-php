...
class WorkspaceUserAuthorizationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Surex\\DocuSign\\Generated\\Model\\WorkspaceUserAuthorization' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Surex\DocuSign\Generated\Model\WorkspaceUserAuthorization;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Surex\DocuSign\Generated\Model\WorkspaceUserAuthorization();
        ...
        if (property_exists($data, 'workspaceUserInformation')) {
            $object->setWorkspaceUserInformation($this->denormalizer->denormalize($data->{'workspaceUserInformation'}, 'Surex\\DocuSign\\Generated\\Model\\WorkspaceUser', 'json', $context));
        }
