...
class UnsupportedFileTypesGetUnsupportedFileTypes extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7HttplugEndpoint
{
     ...
     *
     * @return null|\Surex\DocuSign\Generated\Model\FileTypeList
     */
    protected function transformResponseBody(string $body, int $status, \Symfony\Component\Serializer\SerializerInterface $serializer)
    {
        if (200 === $status) {
            return $serializer->deserialize($body, 'Surex\\DocuSign\\Generated\\Model\\FileTypeList', 'json');
        }
        if (400 === $status) {
            throw new \Surex\DocuSign\Generated\Exception\UnsupportedFileTypesGetUnsupportedFileTypesBadRequestException($serializer->deserialize($body, 'Surex\\DocuSign\\Generated\\Model\\ErrorDetails', 'json'));
        }
    }
}
