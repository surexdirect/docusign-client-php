...
class LoginInformationGetLoginInformation extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7HttplugEndpoint
{
     ...
     *
     * @return null|\Surex\DocuSign\Generated\Model\Authentication
     */
    protected function transformResponseBody(string $body, int $status, \Symfony\Component\Serializer\SerializerInterface $serializer)
    {
        if (200 === $status) {
            return $serializer->deserialize($body, 'Surex\\DocuSign\\Generated\\Model\\Authentication', 'json');
        }
        if (400 === $status) {
            throw new \Surex\DocuSign\Generated\Exception\LoginInformationGetLoginInformationBadRequestException($serializer->deserialize($body, 'Surex\\DocuSign\\Generated\\Model\\ErrorDetails', 'json'));
        }
    }
}
