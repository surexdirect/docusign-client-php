...
class CaptiveRecipientsDeleteCaptiveRecipientsPart extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7HttplugEndpoint
{
     ...
     */
    public function __construct(string $accountId, string $recipientPart, \Surex\DocuSign\Generated\Model\CaptiveRecipientInformation $captiveRecipientInformation)
    {
     ...
     *
     * @return null|\Surex\DocuSign\Generated\Model\CaptiveRecipientInformation
     */
    protected function transformResponseBody(string $body, int $status, \Symfony\Component\Serializer\SerializerInterface $serializer)
    {
        if (200 === $status) {
            return $serializer->deserialize($body, 'Surex\\DocuSign\\Generated\\Model\\CaptiveRecipientInformation', 'json');
        }
        if (400 === $status) {
            throw new \Surex\DocuSign\Generated\Exception\CaptiveRecipientsDeleteCaptiveRecipientsPartBadRequestException($serializer->deserialize($body, 'Surex\\DocuSign\\Generated\\Model\\ErrorDetails', 'json'));
        }
    }
}
