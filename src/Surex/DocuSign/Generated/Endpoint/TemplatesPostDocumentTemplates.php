...
class TemplatesPostDocumentTemplates extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7HttplugEndpoint
{
     ...
     */
    public function __construct(string $accountId, string $documentId, string $envelopeId, \Surex\DocuSign\Generated\Model\DocumentTemplateList $documentTemplateList)
    {
     ...
     *
     * @return null|\Surex\DocuSign\Generated\Model\DocumentTemplateList
     */
    protected function transformResponseBody(string $body, int $status, \Symfony\Component\Serializer\SerializerInterface $serializer)
    {
        if (201 === $status) {
            return $serializer->deserialize($body, 'Surex\\DocuSign\\Generated\\Model\\DocumentTemplateList', 'json');
        }
        if (400 === $status) {
            throw new \Surex\DocuSign\Generated\Exception\TemplatesPostDocumentTemplatesBadRequestException($serializer->deserialize($body, 'Surex\\DocuSign\\Generated\\Model\\ErrorDetails', 'json'));
        }
    }
}
