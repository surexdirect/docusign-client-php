...
class EnvelopesPostEnvelopes extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7HttplugEndpoint
{
    ...
    * }
    */
    function __construct(string $accountId, \Surex\DocuSign\Model\EnvelopeDefinition $envelopeDefinition, array $queryParameters = array())
    {
    ...
    protected function getQueryOptionsResolver() : \Symfony\Component\OptionsResolver\OptionsResolver
    {
        ...
        $optionsResolver->setDefined(array('cdse_mode', 'completed_documents_only', 'merge_roles_on_draft'));
        $optionsResolver->setRequired(array());
        $optionsResolver->setDefaults(array());
        $optionsResolver->setAllowedTypes('cdse_mode', array('string'));
        $optionsResolver->setAllowedTypes('completed_documents_only', array('string'));
        $optionsResolver->setAllowedTypes('merge_roles_on_draft', array('string'));
     ...
     *
     * @return null|\Surex\DocuSign\Model\EnvelopeSummary
     */
    protected function transformResponseBody(string $body, int $status, \Symfony\Component\Serializer\SerializerInterface $serializer)
    {
        if (201 === $status) {
            return $serializer->deserialize($body, 'Surex\\DocuSign\\Model\\EnvelopeSummary', 'json');
        }
        if (400 === $status) {
            throw new \Surex\DocuSign\Exception\EnvelopesPostEnvelopesBadRequestException($serializer->deserialize($body, 'Surex\\DocuSign\\Model\\ErrorDetails', 'json'));
        }
    }
}