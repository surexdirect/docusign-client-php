...
class ChunkedUploadsPutChunkedUploadPart extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7HttplugEndpoint
{
     ...
     */
    public function __construct(string $accountId, string $chunkedUploadId, string $chunkedUploadPartSeq, \Surex\DocuSign\Model\ChunkedUploadRequest $chunkedUploadRequest)
    {
