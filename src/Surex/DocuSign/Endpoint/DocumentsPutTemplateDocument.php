...
class DocumentsPutTemplateDocument extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7HttplugEndpoint
{
     ...
     * }
     */
    public function __construct(string $accountId, string $documentId, string $templateId, \Surex\DocuSign\Model\EnvelopeDefinition $envelopeDefinition, array $queryParameters = [])
    {
