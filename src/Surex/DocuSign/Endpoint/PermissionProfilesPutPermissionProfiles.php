...
class PermissionProfilesPutPermissionProfiles extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7HttplugEndpoint
{
     ...
     * }
     */
    public function __construct(string $accountId, string $permissionProfileId, \Surex\DocuSign\Model\AccountPermissionProfiles $accountPermissionProfiles, array $queryParameters = [])
    {
